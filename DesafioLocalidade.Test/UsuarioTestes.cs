...
#pragma warning disable CS8625 // Não é possível converter um literal nulo em um tipo de referência não anulável.
    ...
    [Fact]
    public async Task CadastrarUsuario_ShouldReturnSuccess_WhenUserIsCreatedSuccessfully()
    {
        // Arrange
    ...
    [Fact]
    public async Task CadastrarUsuario_ShouldReturnErrors_WhenUserCreationFails()
    {
        // Arrange
        var mockUserManager = new Mock<UserManager<IdentityUser>>(
            Mock.Of<IUserStore<IdentityUser>>(), null, null, null, null, null, null, null, null);
